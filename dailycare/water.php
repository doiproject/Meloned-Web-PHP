                ...
                <li>
                    ...
                    <div class="collapse" id="dailycare-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 " style="margin-left: 10%;">
                            <li><a href="#" class="link-dark rounded">การให้น้ำ</a></li>
                ...
                <section class="py-5 text-center container">
                    <div class="row py-lg-5">
                        <div class="col-lg-6 col-md-8 mx-auto">
                            <h1 class="fw-light">การให้น้ำ</h1>
                            <p class="lead text-muted">เพิ่ม/ลบ/แก้ไข ข้อมูลการให้น้ำแต่ละโรงเรือน</p>
                            ...
                            <button type="submit" class="btn btn-outline-success btn-add_water"
                                id="add_water" name="add_water"> เพิ่มการให้น้ำ</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="edit-waterLabel">ข้อมูลการให้น้ำ</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <label for="timepicker">เวลา ตัวอย่าง เช่น 09:09:30 , 13:27:20</label>
