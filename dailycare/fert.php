                ...
                <li>
                    ...
                    <div class="collapse" id="dailycare-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 " style="margin-left: 10%;">
                            ...
                            <li><a href="#" class="link-dark rounded">การให้ปุ๋ย</a></li>
                ...
                <section class="py-5 text-center container">
                    <div class="row py-lg-5">
                        <div class="col-lg-6 col-md-8 mx-auto">
                            <h1 class="fw-light">การให้ปุ๋ย</h1>
                            <p class="lead text-muted">เพิ่ม/ลบ/แก้ไข ข้อมูลการให้ปุ๋ยแต่ละโรงเรือน</p>
                            ...
                            <button type="submit" class="btn btn-outline-success btn-add_fert"
                                id="add_fert" name="add_fert"> เพิ่มการให้ปุ๋ย</button>
                                </form>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="edit-waterLabel">ข้อมูลการให้ปุ๋ย</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <label for="fert" style="margin-top: 15px;">สูตรปู๋ย</label>
                        <p><input type="text" id="fert" name="fert"></p>

                        <label for="fillfert" style="margin-top: 5px;">ปริมาณการให้ปุ๋ย (หน่วยเป็นมิลลิลิตร)</label>
