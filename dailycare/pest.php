<?php
    ...
    if(isset($_SESSION['greenhouseID'])){
        ...
        $sql2 = "SELECT * FROM pest WHERE greenhouseID = '$greenhouseID' AND periodID = '$periodID'";
                ...
                <li>
                    ...
                    <div class="collapse" id="dailycare-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 " style="margin-left: 10%;">
                            ...
                            <li><a href="bio.php" class="link-dark rounded">พ่นชีวภัณฑ์</a></li>
                            <li><a href="#" class="link-dark rounded">พบปัญหา</a></li>
                        </ul>
                    </div>
            ...
            <nav aria-label="breadcrumb">
                ...
                <section class="py-5 text-center container">
                    <div class="row py-lg-5">
                        <div class="col-lg-6 col-md-8 mx-auto">
                            <h1 class="fw-light">รายงานการพบปัญหา</h1>
                            <p class="lead text-muted">เพิ่ม/ลบ/แก้ไข ข้อมูลรายงานการพบปัญหาแต่ละโรงเรือน</p>

                            <form action="../asset/php/addPest.php" method = "POST">
                            ...
                            <button type="submit" class="btn btn-outline-success btn-add_pest"
                                id="add_pest" name="add_pest"> เพิ่มการรายงาน</button>
                            </form>
                ...
                if(isset($_SESSION['greenhouseID'])){
                    ...
                    <a href='#' class='list-group-item list-group-item-action d-flex gap-3 py-3' aria-current='true'>
                        <i class='fa-solid fa-bug' style='font-size: 30px; padding: 8px;'></i>
                        <div class='d-flex gap-2 w-100 justify-content-between'>
                            <div>
                                <h6 class='mb-0'>".$rs2['description']."</h6>
                                <p class='mb-0 opacity-75'>".$rs2['amount']."</p>
                            </div>
                            <!-- <small class='opacity-50 text-nowrap timer'>08:15</small> -->
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="edit-waterLabel">ข้อมูลการรายงานปัญหา</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <label for="pest" style="margin-top: 15px;">ปัญหาที่พบ</label>
                        <p><input type="text" id="pest" name="pest"></p>

                        <label for="amount-pest" style="margin-top: 5px;">จำนวนเมลอนที่พบ (ต้น)</label>
                        <p><input type="text" id="amount-pest" name="amount-pest"></p>
